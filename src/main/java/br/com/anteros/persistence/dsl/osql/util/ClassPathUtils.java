...
public final class ClassPathUtils {
	...
	private static void scanDirectory(ClassLoader classLoader, String pkg, Set<Class<?>> classes, URL url,
					...
					if (listFiles != null) {
						for (File child : listFiles) {
							if (child.getName().endsWith(".class")) {
								String fileName = child.getPath().substring(packagePath.length() + 1)
	...
	private static void scanJar(ClassLoader classLoader, Set<Class<?>> classes, URL url, String packagePath)
			throws IOException {
