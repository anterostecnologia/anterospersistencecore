...
public final class ColumnMetadata implements Serializable {
	...
	/**
	 * Returns this path's column metadata if present. Otherwise returns default metadata where the column name is equal
	 * to the path's name.
	 */
	...
	/**
	 * Creates default column meta data with the given column name, but without any type or constraint information. Use
	 * the fluent builder methods to further configure it.
	 *
