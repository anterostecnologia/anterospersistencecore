...
public class MariaDBDialect extends DatabaseDialect {
	...
	private static Logger log = LoggerProvider.getInstance().getLogger(MariaDBDialect.class.getName());
	...
	public MariaDBDialect(String defaultCatalog, String defaultSchema) {
	...
	public String getSequenceNextValString(String sequenceName) throws Exception {
		throw new DatabaseDialectException(MESSAGES.getMessage(MariaDBDialect.class.getSimpleName() + ".sequenceException", getClass().getName()));
	}
